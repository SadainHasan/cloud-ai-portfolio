...
![Prospects spreadsheet with headers and sample row](day16-project71-google-sheet-setup.png)

### Scenario Builder
![Make.com scenario builder canvas](day16-project71-scenario-builder.png)

### Google Sheets Trigger Module
![Google Sheets Watch New Rows trigger configured](day16-project71-google-sheets-module.png)

### Google Connection Created
![OAuth2 connection to Google authorised](day16-project71-connection-created.png)

### Trigger Configured
![Trigger settings — Prospects spreadsheet, Sheet1, limit 20](day16-project71-trigger-configured.png)

### Module Test Output
![Test run output showing prospect bundle data](day16-project71-module-test-output.png)
